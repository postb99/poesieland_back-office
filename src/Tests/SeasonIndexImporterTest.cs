...
public class SeasonIndexImporterTest(BasicFixture basicFixture): IClassFixture<BasicFixture>
{
    ...
    public void ShouldImport()
    {
        ...
        season.Introduction.ShouldBe($"Mois obsédés où la création le dispute à l'être et l'art musical, tandis qu'un amour éperdu se partage entre romantisme et passion.{Environment.NewLine}{Environment.NewLine}Juin et juillet 1998");
    }
}